...
@Component({
  selector: 'college-predictor-details',
  templateUrl: './college-predictor-details.component.html',
  styleUrls: ['./college-predictor-details.component.css']
})
export class CollagePredicatorDetails {
